...
SECRET_KEY = 'django-insecure-jz4!_&2k_enxn5k+kcno=v3_!ovd8ilzo*1x-s=e!2+4kp5i8r'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'postgres',
        'USER': 'postgres.cjjeuzfovbqyuahigono',
        'PASSWORD': 'Wisdom_ehirim@17',
...
JWT_AUTH = {
    ...
    'JWT_AUTH_HEADER': 'JWT',  # Configure the header for JWT token
    'JWT_ALLOW_REFRESH': True,  # Allow refresh token generation
    #'JWT_EXPIRATION_DELTA': datetime.timedelta(minutes=60),  # Set token expiry time
    # ... other JWT settings
}
# Password validation
